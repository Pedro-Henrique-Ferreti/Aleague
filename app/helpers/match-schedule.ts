...
export async function balanceScheduleWeeks(
  schedule: MatchSchedule,
  teamsCount: number,
...
export async function createMatchSchedule(payload: MatchScheduleParams): Promise<MatchScheduleResponse> {
  ...
  result.schedule = addRoundRobins(result.schedule, payload.roundRobins);
